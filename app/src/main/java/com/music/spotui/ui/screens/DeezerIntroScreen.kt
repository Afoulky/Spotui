...
fun DeezerIntroScreen(navController: NavController) {
    ...
    Box(
        ...
        Column(
            ...
            Text(
                "MeloBridge streams your music from Deezer. Skip this and playback falls back to YouTube instead — slower to load, and some tracks come back censored or as a different edit.",
